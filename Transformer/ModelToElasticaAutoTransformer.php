    ...
    public function transform($object, array $fields)
    {
        ...
        foreach ($fields as $key => $mapping) {
            if (!empty($mapping['_parent']) && $mapping['_parent'] !== '~') {
                $parent = $propertyAccessor->getValue($object, $key);
                $document->setParent($propertyAccessor->getValue($parent, $mapping['_parent']['identifier']));
                ...
                $attachment = $propertyAccessor->getValue($object, $key);
                ...
                $document->add($key, $this->normalizeValue($propertyAccessor->getValue($object, $key)));
            }
        }
        return $document;
    }
